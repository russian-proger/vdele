...
module.exports = (core) => {
    ...
    require('./add-participant-to-organization')        (core, api_router);
    require('./remove-participant-from-project')        (core, api_router);
    require('./remove-participant-from-organization')   (core, api_router);
    ...
    require('./update-user-organization-right')         (core, api_router);
    require('./edit-project-name')                      (core, api_router);
    require('./get-organization')                       (core, api_router);
    require('./get-organization-participants')          (core, api_router);
