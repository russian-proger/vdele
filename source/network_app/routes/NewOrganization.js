        ...
        <Box m={4}>
          <FormControl component="fieldset">
            ...
            <RadioGroup aria-label="privacy" value={state.privacy} onChange={(ev, privacy) => setState({...state, privacy})}>
              ...
              <FormControlLabel value="private" control={<Radio className={classes.radio} color="primary" />} label={PrivacyLabel(LockIcon, '#9a6700', "Приватный", "Видно только участникам")} />
            </RadioGroup>
          </FormControl>
        </Box>
      </Paper>
